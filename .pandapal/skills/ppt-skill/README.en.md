# PPT Skill · Web Decks / Images / Covers
...
```bash
npx skills add <your-skill-url> --skill ppt-skill
```

Or paste this to an AI agent with shell access:

```text
Install ppt-skill for me. Clone <your-skill-repo-url> into ~/.claude/skills/ppt-skill, then verify that SKILL.md, assets/, and references/ exist.
```
...
> 2. Run `git clone <your-skill-repo-url> ~/.claude/skills/ppt-skill`
...
```bash
git clone <your-skill-repo-url> ~/.claude/skills/ppt-skill
```
