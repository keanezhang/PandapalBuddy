...
```text
帮我安装 ppt-skill。请把 <your-skill-repo-url> 克隆到 ~/.claude/skills/ppt-skill,安装完成后检查 SKILL.md、assets/、references/ 是否存在。
```
...
> 2. 执行 `git clone <your-skill-repo-url> ~/.claude/skills/ppt-skill`
